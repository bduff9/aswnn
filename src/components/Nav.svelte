...
<script lang="ts">
  ...
  import { scrollto } from "svelte-scrollto";
	import { Collapse, Container, Nav, Navbar, NavbarBrand, NavbarToggler, NavItem } from 'sveltestrap/src';
...
<Navbar class="navbar-fixed-top navbar-custom{scrollY > 80 ? ' affix' : ' affix-top'}" dark expand="md" id="mainNav">
	<Container>
		<!-- Brand and toggle get grouped for better mobile display -->
		<NavbarBrand class="page-scroll" href="#page-top">A Site With No Name</NavbarBrand>
		<NavbarToggler on:click={() => (isOpen = !isOpen)} />
		<!-- Collect the nav links, forms, and other content for toggling -->
		<Collapse {isOpen} navbar expand="md" on:update={handleUpdate} id="bs-example-navbar-collapse-1">
			<Nav class="ms-auto" navbar>
				<NavItem class="page-scroll">
					<a class="nav-link" use:scrollto={"#portfolio"} href="#portfolio">Projects</a>
				</NavItem>
				<NavItem class="page-scroll">
