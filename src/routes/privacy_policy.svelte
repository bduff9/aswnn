...
-->
<svelte:head>
	<title>Privacy Policy | A Site With No Name</title>
</svelte:head>

<strong>Privacy Policy</strong>
<p>
	Brian Duffey built the NFL Confidence Pool app as an Open Source app. This
	SERVICE is provided by Brian Duffey at no cost and is intended for use as is.
</p>
<p>
...
<p>
	...
	and Conditions, which is accessible at NFL Confidence Pool unless otherwise
...
<p>
	...
	to email, first name, last name, phone number. The information that I request
...
<p>
	...
	personal information, I immediately delete this from our servers. If you are a
	parent or guardian and you are aware that your child has provided us with
	personal information, please contact me so that I will be able to do necessary
	actions.
</p>
...
<p>This policy is effective as of 2021-03-04</p>
