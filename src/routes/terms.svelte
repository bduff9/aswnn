...
-->
<svelte:head>
	<title>Terms & Conditions | A Site With No Name</title>
</svelte:head>
...
<p>
	...
	app. You’re not allowed to copy, or modify the app, any part of the app, or
	our trademarks in any way. You’re not allowed to attempt to extract the source
	code of the app, and you also shouldn’t try to translate the app into other
	languages, or make derivative versions. The app itself, and all the trade
	marks, copyright, database rights and other intellectual property rights
	related to it, still belong to Brian Duffey.
</p>
<p>
	Brian Duffey is committed to ensuring that the app is as useful and efficient
	as possible. For that reason, we reserve the right to make changes to the app
...
<p>
	The NFL Confidence Pool app stores and processes personal data that you have
	...
	NFL Confidence Pool app won’t work properly or at all.
</p>
<div>
	<p>
...
<p>
	You should be aware that there are certain things that Brian Duffey will not
	...
	by your mobile network provider, but Brian Duffey cannot take responsibility
	for the app not working at full functionality if you don’t have access to
...
<p>
	Along the same lines, Brian Duffey cannot always take responsibility for the
	...
	Brian Duffey cannot accept responsibility.
</p>
<p>
	With respect to Brian Duffey’s responsibility for your use of the app, when
	you’re using the app, it’s important to bear in mind that although we
	endeavour to ensure that it is updated and correct at all times, we do rely on
	third parties to provide information to us so that we can make it available to
	you. Brian Duffey accepts no liability for any loss, direct or indirect, you
...
<p>
	...
	on Android &amp; iOS – the requirements for both systems(and for any
	...
	app. Brian Duffey does not promise that it will always update the app so that
	it is relevant to you and/or works with the Android &amp; iOS version that you
	have installed on your device. However, you promise to always accept updates
	to the application when offered to you, We may also wish to stop providing the
...
<p>These terms and conditions are effective as of 2021-03-04</p>
<p><strong>Contact Us</strong></p>
<p>
	If you have any questions or suggestions about my Terms and Conditions, do not
	hesitate to contact me at info@asitewithnoname.com.
</p>
<p>
